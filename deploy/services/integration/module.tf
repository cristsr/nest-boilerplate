...
module "service" {
  ...
  ecs_cluster_id             = data.terraform_remote_state.docred.outputs.integration.cluster_id
...
EOF
  ...
  service_discovery_namespace = data.terraform_remote_state.docred.outputs.integration.namespace
}
